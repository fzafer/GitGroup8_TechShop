public class Tablet_Mustafa extends techEquipments{
    public Tablet_Mustafa(String brand, String model, String color, double price, int expirationYear, boolean isSecondHand) {
